...
int main() {
    ...
    {
        //std::cout << "DEBUG: Skapar S1..." << std::endl;
        Set S1{};
        //std::cout << "DEBUG: Antal noder efter S1: " << Set::get_count_nodes() << std::endl;

        assert(Set::get_count_nodes() == 2);

        Set S2{-4};
       // std::cout << "DEBUG: Antal noder efter S2: " << Set::get_count_nodes() << std::endl;
        assert(Set::get_count_nodes() == 5);

        Set S3{999};
       // std::cout << "DEBUG: Antal noder efter S3: " << Set::get_count_nodes() << std::endl;
